...
<html lang="en">
	<head>
		...
		<title>KOTO Supermercados</title>
...
<%
	...
	String msg;
     ...
     %>
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Informática</h3>
								<a href="AdministrarStore?action=categorias&categoria=INFORMATICA" class="cta-btn">Comprá ahora<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Gaseosas</h3>
								<a href="AdministrarStore?action=categorias&categoria=GASEOSAS" class="cta-btn">Comprá ahora <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div> 
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Carnes</h3>
								<a href="AdministrarStore?action=categorias&categoria=CARNES" class="cta-btn">Comprá ahora<i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
		...
		<!-- /SECTION -->
<!-- EMPIEZA EL DEAL SECTION -->

<!-- TERMINA EL DEAL SECTION -->
<!-- EMPIEZA EL TOP SELLING -->
	 
<!--  TERMINA EL TOP SELLING -->
		<!-- NEWSLETTER -->
