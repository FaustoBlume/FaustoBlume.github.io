...
<body>
			...
			<div class="table-wrapper">
				...
				<div class="clearfix">
					<ul class="pagination" >
						...
						<li class="page-item active"><a href="#" class="page-link">Marca</a></li>
				...
				<table id="tablaProductos" class="table table-striped table-hover">
					...
					<% for (Marca mar : lm) { %>
						<tr id="<%=mar.getId()%>">
							...
							<td><%=mar.getId()%></td>
							<td><%=mar.getDescripcion()%></td>
							<td>
							
								<a href="AdministrarMarca?idMarca=<%=mar.getId()%>&action=buscar" class="edit" data-toggle="modal"    ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								<a href="AdministrarMarca?idMarca=<%=mar.getId()%>&action=eliminar" class="delete" data-toggle="modal" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
	...
	<!-- Agregar Modal HTML -->
	<form class="form-Agregar" action="AdministrarMarca" method="post">
			...
			<div class="modal-content">
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<input name="descripcionMarc"  type="text" class="form-control"  required>
						</div>
