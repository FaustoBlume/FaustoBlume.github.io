...
<body>
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>ABMC <b>Tipos de Productos</b></h2>
						</div>
						<div class="col-xs-6">
				...
				<div class="clearfix">
					<ul class="pagination" >
						...
						<li class="page-item active"><a href="#" class="page-link">Tipo Producto</a></li>
					...
					<% for (Tipo_Producto tp : ltps) { %>
						<tr id="<%=tp.getId()%>">
							...
							<td>
								...
								<a href="AdministrarTipoProducto?idTp=<%=tp.getId()%>&action=buscar" class="edit" data-toggle="modal"    ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								<a href="AdministrarTipoProducto?idTp=<%=tp.getId()%>&action=eliminar" class="delete" data-toggle="modal" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
	...
	<!-- Agregar Modal HTML -->
	<form class="form-Agregar" action="AdministrarTipoProducto" method="post">
			...
			<div class="modal-content">
					...
					<div class="modal-body">					
						<div class="form-group">
							<label>Descripcion (En mayúscula)</label>
							<input name="descripcionTp"  type="text" class="form-control"  required>
						</div>
