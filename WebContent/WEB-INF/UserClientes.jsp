...
<body>
			...
			<div class="table-wrapper">
				...
				<div class="clearfix">
					<ul class="pagination" >
						...
						<li class="page-item active"><a href="AdministrarCliente?action=mostrar" class="page-link">Cliente</a></li>
					</ul>
				</div>
				...
				<table id="tablaProductos" class="table table-striped table-hover">
					...
					<% for (Cliente cli : lc) { %>
						<tr id="<%=cli.getId()%>">
							...
							<td>
								<a href="AdministrarCliente?idCli=<%=cli.getId()%>&action=buscar" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								<a href="AdministrarCliente?idCli=<%=cli.getId()%>&action=eliminar" class="delete" data-toggle="modal" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
	...
	<!-- Agregar Modal HTML -->
	<form class="form-Agregar" action="AdministrarCliente" method="post">
	<input name="var" value=0 type="text" class="form-control"  style="visibility:hidden">
	<input name="rol" value="cliente" type="text" class="form-control"  style="visibility:hidden">
