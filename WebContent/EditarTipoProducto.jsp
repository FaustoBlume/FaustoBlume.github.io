...
<html>
  <head>
  <%
  		Tipo_Producto tp2 = (Tipo_Producto)request.getAttribute("TipoProducto");
	%>
  ...
  <body>
    <div class="testbox">
      <form class="form-signin" action="AdministrarTipoProducto" method="post">
        <h1>Editar Tipo Producto</h1>
        
        <h4>Id</h4>
        <input type="number" name="idTp2"  value="<%=tp2.getId()%>" required  readonly/>
